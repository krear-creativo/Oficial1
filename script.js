...
const translations = {
  es: {
    ...
    'footer.privacy': 'Política de Privacidad',
    'cta.label.doubt': '¿Dudas sobre qué plan elegir?',
    ...
    'svcpage.label': 'Arquitectura de Integración',
    'svcpage.title': 'Servicios <span class=\"text-accent\">Kreär</span>',
    'svcpage.subtitle': 'Diseñamos infraestructura digital estructurada en<br />etapas para ordenar, profesionalizar y escalar tu negocio.',
    'svcpage.note': '<strong>Nota estratégica:</strong> No todas las empresas comienzan desde el paso cero. Evaluamos tu infraestructura actual y nos integramos en la etapa exacta donde hoy existe fricción, sin forzarte a intervenir componentes que ya están resueltos.',
    ...
    'svcpage.friction': 'Fricción que resuelve',
    'svcpage.s1.friction': 'No saber qué está fallando ni por dónde empezar, tomando decisiones sin una lectura estratégica del sistema.',
    'svcpage.result': 'Resultado que entrega',
    'svcpage.s1.result': 'Una hoja de ruta clara para ordenar, priorizar y escalar tu sistema digital con criterio.',
    'svcpage.s2.title': 'Kreär Base',
    'svcpage.s2.friction': 'Tener presencia digital sin estructura, sin integración entre canales y sin resultados concretos.',
    'svcpage.s2.result': 'Un sistema base ordenado que capta oportunidades y convierte de forma consistente.',
    'svcpage.s3.title': 'Kreär Sistema',
    'svcpage.s3.friction': 'Crecimiento desordenado y procesos manuales que generan cuellos de botella operativos.',
    'svcpage.s3.result': 'Un ecosistema integrado que permite escalar con control, trazabilidad y eficiencia.',
    'svcpage.s4.title': 'Kreär Soporte',
    'svcpage.s4.friction': 'Sistemas que pierden eficiencia, quedan desactualizados o frenan la operación del negocio.',
    'svcpage.s4.result': 'Una infraestructura estable, optimizada y en evolución continua según tus nuevos desafíos.',
    'svcpage.s5.title': 'Kreär Marca',
    'svcpage.s5.friction': 'Marcas sin claridad estratégica, sin diferenciación y con mensajes desconectados del negocio.',
    'svcpage.s5.result': 'Una marca sólida, clara y coherente en todos sus puntos de contacto.',
    'svcpage.s6.title': 'Kreär<br />Contenido',
    'svcpage.s6.friction': 'Contenido aislado, sin dirección estratégica ni impacto real sobre objetivos comerciales.',
    'svcpage.s6.result': 'Un sistema de comunicación alineado al negocio y orientado a resultados medibles.',
    'subpage.label': 'Planes Estratégicos',
    'subpage.title': 'Modelos de <span class=\"text-accent\">Suscripción</span>',
    'subpage.subtitle': 'Infraestructura como servicio. Elegí el nivel que mejor acompañe el estado actual de tu empresa para escalar sin fricción.',
    ...
    'stpage.title': '<span>Somos el estudio</span><br />\n                    <span class=\"text-accent\">que te faltaba.</span>',
    'stpage.p1': 'En Kreär trabajamos con empresas que <strong>ya están en movimiento,</strong> pero cuya infraestructura digital no evolucionó al mismo ritmo que su negocio. Eso crea un freno en ventas y control. Cerramos esa brecha.',
    'stpage.p2': 'No comenzamos diseñando. Comenzamos <strong>analizando, pensando y estructurando</strong>. Porque la coherencia genera confianza, la claridad reduce fricción y la dirección precede a la ejecución.',
    'stpage.p3': 'Nuestra visión es convertirnos en el estudio estratégico de referencia que <strong>ordenó la infraestructura y el ecosistema de la región</strong> — y desde ahí, escalar.',
    'stpage.quote': '\"Un sistema ordenado convierte con autonomía.\"',
    'stpage.cta': 'Trabajemos juntos',
    'stpage.location': 'Resistencia, Chaco · Argentina',
    'stpage.tag1': 'Estrategia',
    'stpage.tag2': 'Creatividad',
    'stpage.tag3': 'Dirección',
    'method.label': 'Cómo trabajamos',
    'method.title': '<span>Antes de ejecutar,</span><br /><span class=\"text-accent\">pensamos.</span>',
    'method.subtitle': 'La ejecución es consecuencia del pensamiento estratégico. <br> No al revés.',
    'method.step1.title': 'Evaluamos',
    'method.step1.desc': 'Analizamos tu marca, tu mercado y a tu competencia. Entendemos quién eres, dónde estás y adónde querés ir.',
    'method.step2.title': 'Detectamos',
    'method.step2.desc': 'Identificamos desalineaciones, inconsistencias y oportunidades de mejora. Mapeamos lo que funciona y lo que frena.',
  ...
  en: {
    ...
    'svcpage.label': 'Integration Architecture',
    'svcpage.title': 'Kreär <span class=\"text-accent\">Services</span>',
    'svcpage.subtitle': 'We design structured digital infrastructure in<br />stages to organize, professionalize and scale your business.',
    'svcpage.note': '<strong>Strategic Note:</strong> Not all companies start from scratch. We evaluate your current infrastructure and integrate at the exact stage where friction exists today, without forcing you to intervene in components that are already resolved.',
    ...
    'svcpage.friction': 'Friction it resolves',
    'svcpage.s1.friction': 'Not knowing what is failing or where to start, making decisions without a strategic reading of the system.',
    'svcpage.result': 'Result it delivers',
    'svcpage.s1.result': 'A clear roadmap to organize, prioritize and scale your digital system with criteria.',
    'svcpage.s2.title': 'Kreär Base',
    'svcpage.s2.friction': 'Having digital presence without structure, without integration between channels and without specific results.',
    'svcpage.s2.result': 'An organized base system that captures opportunities and converts consistently.',
    'svcpage.s3.title': 'Kreär System',
    'svcpage.s3.friction': 'Disorganized growth and manual processes that generate operational bottlenecks.',
    'svcpage.s3.result': 'An integrated ecosystem that allows you to scale with control, traceability and efficiency.',
    'svcpage.s4.title': 'Kreär Support',
    'svcpage.s4.friction': 'Systems that lose efficiency, become outdated or slow down business operations.',
    'svcpage.s4.result': 'A stable, optimized infrastructure in continuous evolution according to your new business challenges.',
    'svcpage.s5.title': 'Kreär Brand',
    'svcpage.s5.friction': 'Brands without strategic clarity, without differentiation and with messages disconnected from the business.',
    'svcpage.s5.result': 'A solid, clear and coherent brand across all its touchpoints.',
    'svcpage.s6.title': 'Kreär<br />Content',
    'svcpage.s6.friction': 'Isolated content, without strategic direction or real impact on business objectives.',
    'svcpage.s6.result': 'A communication system aligned with the business and oriented towards measurable results.',
    'subpage.label': 'Strategic Plans',
    'subpage.title': '<span class=\"text-accent\">Subscription</span> Models',
    'subpage.subtitle': 'Infrastructure as a service. Choose the level that best matches the current state of your company to scale without friction.',
    ...
    'stpage.title': '<span>We are the studio</span><br />\n                    <span class=\"text-accent\">you were missing.</span>',
    'stpage.p1': 'At Kreär we work with companies that <strong>are already in motion,</strong> but whose digital infrastructure hasn\'t evolved at the same pace as their business. That creates a friction in sales and control. We close that gap.',
    'stpage.p2': 'We don\'t start by designing. We start by <strong>analyzing, thinking and structuring</strong>. Because coherence builds trust, clarity reduces friction, and direction precedes execution.',
    'stpage.p3': 'Our vision is to become the leading strategic studio that <strong>organized the digital infrastructure and ecosystem of the region</strong> — and from there, scale up.',
    'stpage.quote': '\"An ordered system converts with autonomy.\"',
    'stpage.cta': 'Let\'s work together',
    'stpage.location': 'Resistencia, Chaco · Argentina',
    'stpage.tag1': 'Strategy',
    'stpage.tag2': 'Creativity',
    'stpage.tag3': 'Direction',
    'method.label': 'How we work',
    'method.title': '<span>Before executing,</span><br /><span class=\"text-accent\">we think.</span>',
    'method.subtitle': 'Execution is a consequence of strategic thinking. <br> Not the other way around.',
    'method.step1.title': 'We Evaluate',
    'method.step1.desc': 'We analyze your brand, your market and your competition. We understand who you are, where you are and where you want to go.',
    'method.step2.title': 'We Detect',
    'method.step2.desc': 'We identify misalignments, inconsistencies and improvement opportunities. We map what works and what holds back.',
    'method.step3.title': 'We Define',
    'method.step3.desc': 'We set the strategic direction. The concept, the desired positioning and the communication roadmap.',
    'method.step4.title': 'We Build',
    'method.step4.desc': 'We develop the complete system: identity, messages, pieces, channels. Everything connected. Everything with purpose.',
    'diff.quote1': '\"We don\'t design pieces.',
    'diff.quote2': 'We build systems that sustain the brand over time.\"',
    'diff.market.title': 'The market offers',
    'diff.market.li1': 'Aesthetics without strategy',
