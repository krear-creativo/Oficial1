...
const translations = {
  es: {
    ...
    'hero.subtitle': 'Construimos infraestructura digital estratégica<br />que ayudan a sostener tu negocio en el tiempo.',
    'hero.cta1': 'Nuestros Servicios',
    'hero.cta2': 'Ver Suscripciones',
    ...
    'cta.full.title': '<span>¿Tu sistema</span><br /><span>está a la altura de</span><br /><span class="text-accent">tu empresa?</span>',
    'cta.title_full': '<span>¿Tu sistema</span><br />\n<span>está a la altura de</span><br />\n<span class="text-accent">tu empresa?</span>',
    ...
    'explore.svc.desc': 'Conocé nuestra oferta de soluciones, desde el diagnóstico hasta el mantenimiento continuo.',
    'explore.svc.btn': 'Ver Servicios',
    'explore.sub.title': 'Suscripciones',
    'explore.sub.cap1': 'Escalabilidad',
    'explore.sub.cap2': 'Soporte',
    'explore.sub.cap3': 'Infraestructura',
    'explore.sub.desc': 'Explorá los 4 niveles de infraestructura digital estructurada que te ayudarán a escalar.',
    'explore.sub.btn': 'Ver Planes',
    'explore.about.title': 'Conocenos',
    'explore.about.cap1': 'Filosofía',
    'explore.about.cap2': 'Metodología',
    'explore.about.cap3': 'Estudio',
    'explore.about.desc': 'Descubrí cómo pensamos y nuestra metodología de trabajo detallada.',
    'explore.about.btn': 'Sobre Kreär',
  ...
  en: {
    ...
    'hero.title': 'Your system <span class="text-accent gradient-text">that converts</span>',
    'hero.subtitle': 'We build strategic digital infrastructure<br />that helps sustain your business over time.',
    'hero.cta1': 'Our Services',
    'hero.cta2': 'View Subscriptions',
    ...
    'cta.full.title': '<span>Is your system</span><br /><span>up to the level</span><br /><span class="text-accent">of your company?</span>',
    'cta.title_full': '<span>Is your system</span><br />\n<span>up to the level</span><br />\n<span class="text-accent">of your company?</span>',
    ...
    'explore.svc.desc': 'Discover our range of solutions, from diagnosis to continuous maintenance.',
    'explore.svc.btn': 'View Services',
    'explore.sub.title': 'Subscriptions',
    'explore.sub.cap1': 'Scalability',
    'explore.sub.cap2': 'Support',
    'explore.sub.cap3': 'Infrastructure',
    'explore.sub.desc': 'Explore the 4 levels of structured digital infrastructure that will help you scale.',
    'explore.sub.btn': 'View Plans',
    'explore.about.title': 'About Us',
    'explore.about.cap1': 'Philosophy',
    'explore.about.cap2': 'Methodology',
    'explore.about.cap3': 'Studio',
    'explore.about.desc': 'Discover how we think and our detailed working methodology.',
    'explore.about.btn': 'About Kreär',
