...
/* ============================================================
   SERVICES TIMELINE — LINKED HIGHLIGHT + CURRENT STAGE
   ============================================================ */
function initServicesTimeline() {
  const timelineLinks = Array.from(document.querySelectorAll('.timeline-step[data-step]'));
  const stageCards = Array.from(document.querySelectorAll('.service-stage-card[data-step]'));
  if (!timelineLinks.length || !stageCards.length) return;

  const stepToLink = new Map(timelineLinks.map(link => [link.dataset.step, link]));

  function clearLinkedState() {
    timelineLinks.forEach(link => link.classList.remove('is-linked'));
  }

  function setCurrentStep(step) {
    timelineLinks.forEach(link => {
      link.classList.toggle('is-current', link.dataset.step === step);
    });
  }

  stageCards.forEach(card => {
    const step = card.dataset.step;
    const linked = stepToLink.get(step);
    if (!linked) return;
  ...
  const observer = new IntersectionObserver((entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        setCurrentStep(entry.target.dataset.step);
      }
    });
  }, {
    threshold: 0.55,
  ...
  timelineLinks.forEach(link => {
    link.addEventListener('click', () => {
      clearLinkedState();
      setCurrentStep(link.dataset.step);
    });
  });
}
...
const translations = {
  es: {
    ...
    // Hero
    'hero.badge': 'Web · Automatizaciones · Identidad · Chaco, Argentina',
    'hero.title': 'Tu negocio organizado. <span class="text-accent gradient-text">Tus ventas, en automático.</span>',
    'hero.subtitle': 'Diseñamos tu web, automatizamos tus procesos y ordenamos tu comunicación.<br />Para que tu empresa crezca sola, sin depender de todo.',
    'hero.cta1': 'Ver qué hacemos',
    'hero.cta2': 'Ver Planes',
    'hero.stat1': 'Empresas que ya venden más',
    'hero.stat2': 'Años haciendo esto',
    'hero.stat3': 'Enfocados en resultados reales',

    // Social proof
    'proof.label': 'Empresas que ya venden mejor con Kreär',
    ...
    'method.step3.desc': 'Establecemos la dirección estratégica. El concepto, la arquitectura de conversiones y la hoja de ruta.',
    ...
    'about.p1.rest': 'pero cuya infraestructura digital no evolucionó al mismo ritmo que su negocio. Eso crea un freno operativo y visual. Solucionamos ese problema.',
    ...
    'about.p3.strong': 'ordenó la infraestructura digital de la región',
    ...
    'test.title.accent': 'nuestros clientes',
    'test.q1': '\"Kreär hizo algo que ninguna agencia anterior había logrado: entender cómo funciona realmente nuestra empresa y armar un sistema que trabaja solo. <strong>Ahora tenemos presencia, claridad y las consultas llegaron solas.</strong>\"',
    'test.q2': '\"Lo que más valoro es que no empiezan diseñando, empiezan entendiendo el negocio. Detectaron problemas que teníamos hace años y que nunca habíamos visto. <strong>A partir de ahí, todo empezó a funcionar mejor.</strong>\"',
    'test.q3': '\"Antes la gente no entendía bien qué hacíamos. Después de trabajar con Kreär, los clientes llegan sabiendo lo que somos. <strong>Eso vale más que cualquier publicidad.</strong>\"',

    // CTA
    'cta.label': '¿Tu negocio puede vender más?',
    'cta.full.title': '<span>Hablemos.</span><br /><span>Te decimos qué</span><br /><span class="text-accent">está frenando tus ventas.</span>',
    'cta.title_full': '<span>Hablemos.</span><br />\n<span>Te decimos qué</span><br />\n<span class="text-accent">está frenando tus ventas.</span>',
    'cta.subtitle': 'Si tu negocio creció pero las ventas no acompañaron, es momento de ordenar el sistema. Empezamos con una charla sin compromiso.',
    'cta.button': 'Quiero saber qué me frena',
    ...
    'form.message.label': 'Consulta',
    'form.submit': 'Enviar consulta',
    'footer.col.sitemap': 'Mapa del Sitio',
    'footer.link.studio': 'El Estudio',
    'footer.col.contact': 'Contacto',
    'footer.contact.location': 'Resistencia, Chaco, Argentina',
    'footer.privacy': 'Política de Privacidad',
    'cta.label.doubt': '¿No sabés cuál plan te conviene?',
    'explore.svc.title': 'Servicios',
    'explore.svc.cap1': 'Auditoría',
    'explore.svc.cap2': 'Desarrollo',
    'explore.svc.cap3': 'Mantenimiento',
    'explore.svc.desc': 'Web estratégica, automatizaciones, identidad y campañas. Todo lo que necesitás para ordenar tu negocio y vender más.',
    'explore.svc.btn': 'Ver qué hacemos',
    'explore.sub.title': 'Planes',
    'explore.sub.cap1': 'Escalabilidad',
    'explore.sub.cap2': 'Soporte',
    'explore.sub.cap3': 'Resultados',
    'explore.sub.desc': 'Cuatro niveles de servicio adaptados a tu empresa. Empezás con lo que necesitás y escalás cuando estés listo.',
    'explore.sub.btn': 'Ver Planes',
    'explore.about.title': 'Quiénes somos',
    'explore.about.cap1': 'Cómo trabajamos',
    'explore.about.cap2': 'Por qué funciona',
    'explore.about.cap3': 'El equipo',
    'explore.about.desc': 'Somos un equipo de estrategia, diseño y tecnología. Conocé cómo trabajamos y por qué da resultados.',
    'explore.about.btn': 'Conocer el estudio',
    'svcpage.label': 'Web · Automatizaciones · Marca',
    'svcpage.title': 'Servicios <span class=\"text-accent\">Kreär</span>',
    'svcpage.subtitle': 'Diseñamos tu web, automatizamos tus procesos y construimos tu identidad.<br />Todo en etapas. Empezamos exactamente donde lo necesitás.',
    'svcpage.note': '<strong>¿En qué etapa estás?</strong> No todas las empresas empiezan desde cero. Evaluamos lo que ya tenés y arrancamos en el punto donde hay más fricción — sin rehacer lo que ya funciona.',
    'svcpage.t1': 'Diagnóstico',
    'svcpage.t2': 'Base',
    'svcpage.t3': 'Sistema',
    'svcpage.t4': 'Soporte',
    'svcpage.t5': 'Marca',
    'svcpage.t6': 'Contenido',
    'svcpage.s1.title': 'Kreär Diagnóstico',
    'svcpage.btn.detail': 'Conocer servicio en detalle',
    'svcpage.friction': 'El problema que resuelve',
    'svcpage.s1.friction': 'Tomás decisiones sin saber qué está fallando. Sin un diagnóstico claro, cualquier cambio puede ser plata tirada.',
    'svcpage.result': 'Lo que lográs',
    'svcpage.s1.result': 'Un mapa claro de qué cambiar, en qué orden y por qué. Sin suposiciones — con datos reales de tu negocio.',
    'svcpage.s2.title': 'Kreär Base',
    'svcpage.s2.friction': 'Tenés redes o una web, pero no generan consultas reales. Presencia sin estructura no convierte.',
    'svcpage.s2.result': 'Una web que explica lo que hacés, atrae a tus clientes y convierte visitantes en consultas concretas.',
    'svcpage.s3.title': 'Kreär Sistema',
    'svcpage.s3.friction': 'Respondés mensajes a mano, hacés seguimientos a mano, enviás información a mano. Eso te frena y limita tu crecimiento.',
    'svcpage.s3.result': 'Tareas repetitivas funcionan solas: respuestas automáticas, seguimientos, notificaciones. Tu negocio escala sin que estés en todo.',
    'svcpage.s4.title': 'Kreär Soporte',
    'svcpage.s4.friction': 'Tu web o tus herramientas se rompen, se quedan desactualizadas o dejan de funcionar bien — y no tenés con quién resolverlo rápido.',
    'svcpage.s4.result': 'Alguien se encarga de que todo funcione. Si algo falla, lo resolvemos antes de que afecte a tus clientes.',
    'svcpage.s5.title': 'Kreär Marca',
    'svcpage.s5.friction': 'Tu empresa hace cosas buenas, pero desde afuera no se percibe así. La imagen no refleja quiénes son realmente.',
    'svcpage.s5.result': 'Una marca que comunica con claridad qué hacés y por qué sos la mejor opción para tu cliente ideal.',
    'svcpage.s6.title': 'Kreär<br />Contenido',
    'svcpage.s6.friction': 'Publicás cosas sueltas sin saber si generan algún resultado. Sin estrategia, el contenido es ruido.',
    'svcpage.s6.result': 'Contenido que atrae, genera confianza y lleva a la compra. No solo likes.',
    'subpage.label': 'Planes Estratégicos',
    'subpage.title': 'Modelos de <span class=\"text-accent\">Suscripción</span>',
    'subpage.subtitle': 'Cuatro niveles de servicio. Empezás con lo que tu negocio necesita hoy y escalás cuando estés listo.',
    'subpage.p1.level': 'Nivel 1',
    'subpage.p1.title': 'Esencial',
    'subpage.p1.price': '$60.000 <span data-i18n=\"subpage.price.mo\">ARS/mes</span>',
    'subpage.price.mo': 'ARS/mes',
    'subpage.p1.f1': 'Landing page estratégica',
    'subpage.p1.f2': 'Conversión a WhatsApp',
    'subpage.p1.f3': 'Hosting y dominio incluidos',
    'subpage.p1.f4': 'Diseño responsive/mobile',
    'subpage.p1.f5': '1 ajuste menor por mes',
    'subpage.p1.f6': 'Reporte básico mensual',
    'subpage.btn': 'Seleccionar Plan',
    'subpage.p2.level': 'Nivel 2',
    'subpage.p2.title': 'Profesional',
    'subpage.p2.price': '$90.000 <span data-i18n=\"subpage.price.mo\">ARS/mes</span>',
    'subpage.p2.f1': 'Sitio web de 3 a 5 páginas',
    'subpage.p2.f2': 'Formularios de contacto',
    'subpage.p2.f3': 'Integración con WhatsApp',
    'subpage.p2.f4': 'Automatización básica',
    'subpage.p2.f5': '2 ajustes mensuales',
    'subpage.p3.level': 'Nivel 3',
    'subpage.p3.title': 'Sistema',
    'subpage.p3.price': '$160.000 <span data-i18n=\"subpage.price.mo\">ARS/mes</span>',
    'subpage.p3.f1': 'Todo lo del Nivel 2',
    'subpage.p3.f2': 'Automatizaciones avanzadas',
    'subpage.p3.f3': 'Gestión de consultas',
    'subpage.p3.f4': 'Lógica de conversión',
    'subpage.p3.f5': 'Métricas y seguimiento',
    'subpage.p3.f6': '3 ajustes mensuales',
    'subpage.p4.level': 'Nivel 4',
    'subpage.p4.title': 'Empresarial',
    'subpage.p4.price': 'Cotización <span data-i18n=\"subpage.price.custom\">Personalizada</span>',
    'subpage.price.custom': 'Personalizada',
    'subpage.p4.f1': 'Todo lo del Nivel 3',
    'subpage.p4.f2': 'Sistemas más complejos',
    'subpage.p4.f3': 'Integraciones de pago',
    'subpage.p4.f4': 'Automatizaciones avanzadas',
    'subpage.p4.f5': 'Flujos personalizados',
    'subpage.p4.f6': 'Soporte prioritario',
    'subpage.btn.contact': 'Contactar',
    'stpage.label': 'El Estudio',
    'stpage.title': '<span>Hacemos que tu empresa</span><br />\n                    <span class=\"text-accent\">trabaje por vos.</span>',
    'stpage.p1': 'En Kreär <strong>diseñamos tu web, automatizamos tus procesos y ordenamos tu comunicación.</strong> Trabajamos con empresas que ya están creciendo, pero que aún dependen demasiado del dueño para funcionar.',
    'stpage.p2': 'No arrancamos dibujando logos. Arrancamos <strong>entendiendo tu negocio</strong>: qué hacés, qué te frena, cuánto tiempo perdés en tareas que podrían funcionar solas. Después construimos exactamente lo que necesitás.',
    'stpage.p3': 'Somos un equipo de estrategia, diseño y tecnología en Resistencia, Chaco. Más de <strong>50 empresas de la región</strong> ya venden mejor y trabajan menos gracias al sistema que armamos juntos.',
    'stpage.quote': '\"El mejor vendedor de tu empresa puede ser tu propio sistema.\"',
    'stpage.cta': 'Hablemos de tu negocio',
    'stpage.location': 'Resistencia, Chaco · Argentina',
    'stpage.tag1': 'Web',
    'stpage.tag2': 'Automatizaciones',
    'stpage.tag3': 'Marca',
    'method.label': 'Cómo trabajamos',
    'method.title': '<span>Antes de tocar nada,</span><br /><span class=\"text-accent\">entendemos tu negocio.</span>',
    'method.subtitle': 'Nos tomamos el tiempo de conocer cómo funciona tu empresa antes de proponer cualquier solución.',
    'method.step1.title': 'Evaluamos',
    'method.step1.desc': 'Analizamos tu negocio, tu mercado y a tu competencia. Entendemos qué hacés, cómo vendés y dónde está el problema real.',
    'method.step2.title': 'Detectamos',
    'method.step2.desc': 'Encontramos qué está frenando tus ventas: qué no comunica bien, qué proceso te roba tiempo, qué herramienta no está convirtiendo.',
    'method.step3.title': 'Definimos',
    'method.step3.desc': 'Diseñamos el plan: qué construir, en qué orden y por qué. Sin saltarse pasos ni duplicar esfuerzo.',
    'method.step4.title': 'Construimos',
    'method.step4.desc': 'Ejecutamos: web, automatizaciones, identidad, contenido. Todo conectado. Todo con el objetivo de que tu negocio venda más.',
    'diff.quote1': '\"Otras agencias te hacen un logo.',
    'diff.quote2': 'Nosotros te armamos el sistema que hace que tu negocio venda.\"',
    'diff.market.title': 'El mercado ofrece',
    'diff.market.li1': 'Logo sin estrategia de venta',
    'diff.market.li2': 'Redes lindas, sin consultas',
    'diff.market.li3': 'Publicidad sin resultado medible',
    'diff.krear.title': 'Kreär ofrece',
    'diff.krear.li1': 'Web + automatizaciones que convierten',
    'diff.krear.li2': 'Identidad que explica lo que hacés',
    'diff.krear.li3': 'Sistema que trabaja aunque no estés',
    'footer.tagline.full': 'Una marca ordenada <span class="text-accent">vende sin gritar.</span>',
  },
  ...
  en: {
    ...
    // Hero
    'hero.badge': 'Web · Automations · Branding · Chaco, Argentina',
    'hero.title': 'Your business organized. <span class="text-accent gradient-text">Your sales, on autopilot.</span>',
    'hero.subtitle': 'We design your website, automate your processes and organize your communication.<br />So your business grows on its own, without depending on everything.',
    'hero.cta1': 'See what we do',
    'hero.cta2': 'See Plans',
    'hero.stat1': 'Businesses selling more',
    'hero.stat2': 'Years doing this',
    'hero.stat3': 'Focused on real results',
    'footer.tagline.full': 'An ordered brand <span class="text-accent">sells without shouting.</span>',

    // Social proof
    'proof.label': 'Businesses already selling better with Kreär',
    ...
    'test.title': 'What our',
    'test.title.accent': 'clients say',
    'test.q1': '"Kreär did something no previous agency had managed: they understood how our business really works. <strong>Now we have presence, clarity, and inquiries started coming on their own.</strong>"',
    'test.q2': '"What I value most is that they don\'t start by designing, they start by understanding the business. The diagnosis was spot on. <strong>From that point on, everything started to work better.</strong>"',
    'test.q3': '"Before, people didn\'t fully understand what we did. After working with Kreär, we gained recognition in the right places. <strong>That\'s worth more than any advertising.</strong>"',

    // CTA
    'cta.label': 'Can your business sell more?',
    'cta.full.title': '<span>Let\'s talk.</span><br /><span>We\'ll tell you what\'s</span><br /><span class="text-accent">holding back your sales.</span>',
    'cta.title_full': '<span>Let\'s talk.</span><br />\n<span>We\'ll tell you what\'s</span><br />\n<span class="text-accent">holding back your sales.</span>',
    'cta.subtitle': 'If your business grew but sales didn\'t keep up, it\'s time to organize the system. We start with a no-commitment conversation.',
    'cta.button': 'I want to know what\'s holding me back',
    ...
    'footer.link.studio': 'The Studio',
    'footer.col.contact': 'Contact',
    'footer.contact.location': 'Resistencia, Chaco, Argentina',
    'footer.privacy': 'Privacy Policy',
    'cta.label.doubt': 'Doubts about which plan to choose?',
    'explore.svc.title': 'Services',
    'explore.svc.cap1': 'Auditing',
    'explore.svc.cap2': 'Development',
    'explore.svc.cap3': 'Maintenance',
    'explore.svc.desc': 'Strategic web, automations, branding and campaigns. Everything you need to organize your business and sell more.',
    'explore.svc.btn': 'See what we do',
    'explore.sub.title': 'Plans',
    'explore.sub.cap1': 'Scalability',
    'explore.sub.cap2': 'Support',
    'explore.sub.cap3': 'Results',
    'explore.sub.desc': 'Four service levels tailored to your business. Start with what you need and scale when you\'re ready.',
    'explore.sub.btn': 'See Plans',
    'explore.about.title': 'Who we are',
    'explore.about.cap1': 'How we work',
    'explore.about.cap2': 'Why it works',
    'explore.about.cap3': 'The team',
    'explore.about.desc': 'We\'re a team of strategy, design and technology. Find out how we work and why it delivers results.',
    'explore.about.btn': 'Meet the studio',
    'svcpage.label': 'Web · Automations · Branding',
    'svcpage.title': 'Kreär <span class=\"text-accent\">Services</span>',
    'svcpage.subtitle': 'We design your website, automate your processes and build your brand.<br />Step by step. We start exactly where you need us to.',
    'svcpage.note': '<strong>Where are you right now?</strong> Not every business starts from zero. We assess what you already have and step in at the exact point of friction — without rebuilding what\'s already working.',
    'svcpage.t1': 'Diagnosis',
    'svcpage.t2': 'Base',
    'svcpage.t3': 'System',
    'svcpage.t4': 'Support',
    'svcpage.t5': 'Brand',
    'svcpage.t6': 'Content',
    'svcpage.s1.title': 'Kreär Diagnosis',
    'svcpage.btn.detail': 'View service in detail',
    'svcpage.friction': 'The problem it solves',
    'svcpage.s1.friction': 'You\'re making decisions without knowing what\'s failing. Without a clear diagnosis, any change could be wasted money.',
    'svcpage.result': 'What you get',
    'svcpage.s1.result': 'A clear map of what to change, in what order and why. No guesswork — based on real data from your business.',
    'svcpage.s2.title': 'Kreär Base',
    'svcpage.s2.friction': 'You have social media or a website, but they\'re not generating real inquiries. Presence without structure doesn\'t convert.',
    'svcpage.s2.result': 'A website that explains what you do, attracts your clients and converts visitors into real inquiries.',
    'svcpage.s3.title': 'Kreär System',
    'svcpage.s3.friction': 'You reply to messages manually, do follow-ups manually, send information manually. That limits your growth.',
    'svcpage.s3.result': 'Repetitive tasks start running on their own: automated replies, follow-ups, notifications. Your business scales without you having to be in everything.',
    'svcpage.s4.title': 'Kreär Support',
    'svcpage.s4.friction': 'Your website or tools break down, go outdated or stop working well — and you don\'t have anyone to fix it fast.',
    'svcpage.s4.result': 'Someone takes care of keeping everything running. If something breaks, we fix it before it affects your clients.',
    'svcpage.s5.title': 'Kreär Brand',
    'svcpage.s5.friction': 'Your company does great work, but it doesn\'t come across that way from the outside. Your image doesn\'t reflect who you really are.',
    'svcpage.s5.result': 'A brand that clearly communicates what you do and why you\'re the best choice for your ideal client.',
    'svcpage.s6.title': 'Kreär<br />Content',
    'svcpage.s6.friction': 'You post things randomly without knowing if they generate any results. Without strategy, content is just noise.',
    'svcpage.s6.result': 'Content that attracts, builds trust and leads to purchase. Not just likes.',
    'subpage.label': 'Strategic Plans',
    'subpage.title': '<span class=\"text-accent\">Subscription</span> Models',
    'subpage.subtitle': 'Four service levels. Start with what your business needs today and scale when you\'re ready.',
    'subpage.p1.level': 'Level 1',
    'subpage.p1.title': 'Essential',
    'subpage.p1.price': '$60.000 <span data-i18n=\"subpage.price.mo\">ARS/mo</span>',
    'subpage.price.mo': 'ARS/mo',
    'subpage.p1.f1': 'Strategic landing page',
    'subpage.p1.f2': 'WhatsApp conversion',
    'subpage.p1.f3': 'Hosting and domain included',
    'subpage.p1.f4': 'Responsive/mobile design',
    'subpage.p1.f5': '1 minor adjustment per month',
    'subpage.p1.f6': 'Basic monthly report',
    'subpage.btn': 'Select Plan',
    'subpage.p2.level': 'Level 2',
    'subpage.p2.title': 'Professional',
    'subpage.p2.price': '$90.000 <span data-i18n=\"subpage.price.mo\">ARS/mo</span>',
    'subpage.p2.f1': '3 to 5 page website',
    'subpage.p2.f2': 'Contact forms',
    'subpage.p2.f3': 'WhatsApp integration',
    'subpage.p2.f4': 'Basic automation',
    'subpage.p2.f5': '2 target monthly adjustments',
    'subpage.p3.level': 'Level 3',
    'subpage.p3.title': 'System',
    'subpage.p3.price': '$160.000 <span data-i18n=\"subpage.price.mo\">ARS/mo</span>',
    'subpage.p3.f1': 'Everything in Level 2',
    'subpage.p3.f2': 'Advanced automations',
    'subpage.p3.f3': 'Inquiry management',
    'subpage.p3.f4': 'Conversion logic',
    'subpage.p3.f5': 'Metrics and tracking',
    'subpage.p3.f6': '3 monthly adjustments',
    'subpage.p4.level': 'Level 4',
    'subpage.p4.title': 'Enterprise',
    'subpage.p4.price': 'Custom <span data-i18n=\"subpage.price.custom\">Pricing</span>',
    'subpage.price.custom': 'Pricing',
    'subpage.p4.f1': 'Everything in Level 3',
    'subpage.p4.f2': 'More complex systems',
    'subpage.p4.f3': 'Payment integrations',
    'subpage.p4.f4': 'Advanced automations',
    'subpage.p4.f5': 'Custom flows',
    'subpage.p4.f6': 'Priority support',
    'subpage.btn.contact': 'Contact Us',
    'stpage.label': 'The Studio',
    'stpage.title': '<span>We make your business</span><br />\n                    <span class=\"text-accent\">work for you.</span>',
    'stpage.p1': 'At Kreär <strong>we design your website, automate your processes and organize your communication.</strong> We work with businesses that are already growing, but still depend too much on the owner to run well.',
    'stpage.p2': 'We don\'t start by drawing logos. We start by <strong>understanding your business</strong>: what you do, what\'s holding you back, how much time you lose on tasks that could run on their own. Then we build exactly what you need.',
    'stpage.p3': 'We\'re a team of strategy, design and technology in Resistencia, Chaco. Over <strong>50 businesses in the region</strong> are already selling more and working less thanks to the system we built together.',
    'stpage.quote': '\"The best salesperson in your company can be your own system.\"',
    'stpage.cta': 'Let\'s talk about your business',
    'stpage.location': 'Resistencia, Chaco · Argentina',
    'stpage.tag1': 'Web',
    'stpage.tag2': 'Automations',
    'stpage.tag3': 'Branding',
    'method.label': 'How we work',
    'method.title': '<span>Before touching anything,</span><br /><span class=\"text-accent\">we understand your business.</span>',
    'method.subtitle': 'We take the time to understand how your company works before proposing any solution.',
    'method.step1.title': 'We Evaluate',
    'method.step1.desc': 'We analyze your business, your market and your competition. We understand what you do, how you sell and where the real problem is.',
    'method.step2.title': 'We Detect',
    'method.step2.desc': 'We find what\'s holding back your sales: what doesn\'t communicate well, which process wastes your time, which tool isn\'t converting.',
    'method.step3.title': 'We Define',
    'method.step3.desc': 'We design the plan: what to build, in what order and why. No skipped steps, no duplicated effort.',
    'method.step4.title': 'We Build',
    'method.step4.desc': 'We execute: website, automations, branding, content. Everything connected. Everything with the goal of selling more.',
    'diff.quote1': '\"Other agencies design pieces.',
    'diff.quote2': 'We build the system that makes your business sell.\"',
    'diff.market.title': 'The market offers',
    'diff.market.li1': 'Logo without a sales strategy',
    'diff.market.li2': 'Nice social media, no inquiries',
    'diff.market.li3': 'Advertising without measurable results',
    'diff.krear.title': 'Kreär offers',
    'diff.krear.li1': 'Website + automations that convert',
    'diff.krear.li2': 'Branding that explains what you do',
    'diff.krear.li3': 'A system that works even when you\'re not there',
  },
};
